...
```
# 13. Validation Results The following results were obtained using the best validation checkpoint. ### No TTA vs. Flip-Averaged TTA | Class       | IoU (No TTA) |  IoU (TTA) | Dice (No TTA) | Dice (TTA) | Precision (No TTA) | Precision (TTA) | Recall (No TTA) | Recall (TTA) || ----------- | -----------: | ---------: | ------------: | ---------: | -----------------: | --------------: | --------------: | -----------: || Background  |       0.5004 | **0.5125** |        0.6670 | **0.6777** |             0.6343 |      **0.6404** |          0.7033 |   **0.7196** || Building    |       0.5439 | **0.5665** |        0.7046 | **0.7233** |             0.6174 |      **0.6402** |          0.8204 |   **0.8311** || Road        |       0.5309 | **0.5428** |        0.6935 | **0.7037** |             0.7229 |      **0.7393** |          0.6665 |   **0.6714** || Water       |       0.6417 | **0.6523** |        0.7818 | **0.7896** |             0.7192 |      **0.7273** |          0.8563 |   **0.8635** || Barren      |       0.3322 | **0.3455** |        0.4988 | **0.5136** |             0.5182 |      **0.5443** |          0.4808 |   **0.4861** || Forest      |       0.3618 | **0.3669** |        0.5314 | **0.5369** |             0.4971 |      **0.5048** |          0.5707 |   **0.5733** || Agriculture |       0.5165 | **0.5238** |        0.6812 | **0.6875** |             0.8363 |      **0.8434** |          0.5746 |   **0.5803** || **Mean**    |   **0.4896** | **0.5015** |    **0.6512** | **0.6617** |                  — |               — |               — |            — | ### Overall Metrics | Metric             | No TTA |   With TTA | Absolute Improvement || ------------------ | -----: | ---------: | -------------------: || **Mean IoU**       | 0.4896 | **0.5015** |          **+0.0119** || **Mean Dice**      | 0.6512 | **0.6617** |          **+0.0105** || **Pixel Accuracy** | 0.6717 | **0.6815** |          **+0.0098** |
